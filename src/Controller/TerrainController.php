...
class TerrainController extends AbstractController
{
    ...
    ////////////////////////////////////// FOR ADMIN ////////////////////////////////////////////////////////////////////////
    #[Route('/terrain_listadmin', name: 'terrain_listadmin', methods: ['GET'])]
    public function indexx(TerrainRepository $terrainRepository): Response
    {
        $terrains = $terrainRepository->findAll();
        return $this->render('terrain/indexback.html.twig', [
            'terrains' => $terrains,
        ]);
    }

    #[Route(path: '/terrain/{id}', name: 'terrain_showadmin', methods: ['GET'])]
    public function showw(Terrain $terrain, OpenWeatherService $weatherService): Response
    {
        ...
        return $this->render('terrain/showadmin.html.twig', [
            'terrain' => $terrain,
    ...
    #[Route('/terrain-edit/{id}', name: 'terrain_editback', methods: ['GET', 'POST'])]
    public function editt(Request $request, Terrain $terrain): Response
    {
        $form = $this->createForm(TerrainType::class, $terrain);
        $form->handleRequest($request);
        ...
        return $this->render('terrain/editback.html.twig', [
            'terrain' => $terrain,
            'form' => $form->createView(),
        ]);
    }
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////
    #[Route(path: '/terrainback/{id}', name: 'terrain_show', methods: ['GET'])]
    ...
    #[Route('/terrain-edit/{id}', name: 'terrain_edit', methods: ['GET', 'POST'])]
