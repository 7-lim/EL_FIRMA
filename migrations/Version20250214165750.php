 ...
 */
final class Version20250214165750 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ticket (id INT AUTO_INCREMENT NOT NULL, agriculteur_id INT DEFAULT NULL, expert_id INT DEFAULT NULL, evenement_id INT NOT NULL, prix INT NOT NULL, INDEX IDX_97A0ADA37EBB810E (agriculteur_id), INDEX IDX_97A0ADA3C5568CE4 (expert_id), INDEX IDX_97A0ADA3FD02F13 (evenement_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
