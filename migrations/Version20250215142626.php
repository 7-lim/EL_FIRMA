 ...
 */
final class Version20250215142626 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE utilisateur ADD roles JSON NOT NULL COMMENT \'(DC2Type:json)\', ADD password VARCHAR(255) NOT NULL, ADD type VARCHAR(255) NOT NULL, ADD adresse_exploitation VARCHAR(255) DEFAULT NULL, ADD nom_entreprise VARCHAR(255) DEFAULT NULL, ADD id_fiscale VARCHAR(50) DEFAULT NULL, ADD categorie_produit VARCHAR(255) DEFAULT NULL, ADD domaine_expertise VARCHAR(255) DEFAULT NULL, ADD actif TINYINT(1) DEFAULT NULL, DROP role, DROP mot_de_passe, DROP disc, CHANGE nom nom VARCHAR(255) DEFAULT NULL, CHANGE prenom prenom VARCHAR(255) DEFAULT NULL, CHANGE email email VARCHAR(180) NOT NULL, CHANGE telephone telephone VARCHAR(15) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE utilisateur ADD role VARCHAR(55) NOT NULL, ADD mot_de_passe VARCHAR(255) NOT NULL, ADD disc VARCHAR(255) NOT NULL, DROP roles, DROP password, DROP type, DROP adresse_exploitation, DROP nom_entreprise, DROP id_fiscale, DROP categorie_produit, DROP domaine_expertise, DROP actif, CHANGE email email VARCHAR(55) NOT NULL, CHANGE nom nom VARCHAR(55) NOT NULL, CHANGE prenom prenom VARCHAR(55) NOT NULL, CHANGE telephone telephone INT NOT NULL');
    }
}
